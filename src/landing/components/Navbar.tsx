  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-5 md:px-12 py-4 bg-white/80 backdrop-blur-xl border-b border-border">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <a
          href="#cta"
          className="inline-flex items-center px-5 py-2.5 rounded-full bg-brand-primary text-white text-sm font-semibold hover:bg-emerald-600 hover:-translate-y-0.5 shadow-md shadow-brand-primary/20 transition-all duration-300"
        >
          Get Started
        </a>
      </div>
